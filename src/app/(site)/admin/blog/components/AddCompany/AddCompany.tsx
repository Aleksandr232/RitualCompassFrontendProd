...
import usePostBlogRequest from "@/helpers/usePostBlogRequest/usePostBlogRequest";
import AddBlogForm from "@/components/Form/AddBlogForm/AddBlogForm";
...
const AddCompany = () => {
  ...
  const { addNewBlog } = usePostBlogRequest();
